...
from .views_admin_features import (
    admin_feature_management, admin_user_feature_access,
    feature_list_api, update_feature_status_api, update_user_feature_access_api,
    batch_update_feature_status_api, batch_update_user_feature_access_api,
...
urlpatterns = [
    ...
    path('api/admin/user-features/batch-update/', batch_update_user_feature_access_api, name='batch_update_user_feature_access_api'),
]
