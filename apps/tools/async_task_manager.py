...
class AsyncTaskManager:
    ...
    def create_task(self, requirement: str, user_prompt: str, is_batch: bool = False, 
                   batch_id: int = 0, total_batches: int = 1, user_id: str = None) -> str:
        """创建新的后台任务"""
