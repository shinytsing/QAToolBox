...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        nutrition_data = {
            # 中餐
            '宫保鸡丁': {'calories': 320, 'protein': 25, 'fat': 18, 'carbohydrates': 15, 'fiber': 2, 'sugar': 8, 'sodium': 850},
            '麻婆豆腐': {'calories': 280, 'protein': 18, 'fat': 22, 'carbohydrates': 8, 'fiber': 3, 'sugar': 2, 'sodium': 1200},
            '红烧肉': {'calories': 450, 'protein': 28, 'fat': 35, 'carbohydrates': 5, 'fiber': 1, 'sugar': 3, 'sodium': 680},
            '糖醋里脊': {'calories': 380, 'protein': 22, 'fat': 20, 'carbohydrates': 25, 'fiber': 1, 'sugar': 15, 'sodium': 720},
            '鱼香肉丝': {'calories': 290, 'protein': 20, 'fat': 16, 'carbohydrates': 18, 'fiber': 2, 'sugar': 10, 'sodium': 890},
            ...
            '剁椒鱼头': {'calories': 280, 'protein': 32, 'fat': 16, 'carbohydrates': 5, 'fiber': 2, 'sugar': 2, 'sodium': 1100},
            ...
            '豆浆油条': {'calories': 320, 'protein': 12, 'fat': 18, 'carbohydrates': 35, 'fiber': 3, 'sugar': 8, 'sodium': 680},
            '煎蛋三明治': {'calories': 280, 'protein': 15, 'fat': 12, 'carbohydrates': 32, 'fiber': 2, 'sugar': 5, 'sodium': 450},
            '中式炒面': {'calories': 420, 'protein': 18, 'fat': 22, 'carbohydrates': 45, 'fiber': 3, 'sugar': 8, 'sodium': 1200},
            ...
            '美式烤肋排': {'calories': 420, 'protein': 35, 'fat': 28, 'carbohydrates': 8, 'fiber': 1, 'sugar': 6, 'sodium': 680},
            '法式吐司': {'calories': 320, 'protein': 12, 'fat': 18, 'carbohydrates': 28, 'fiber': 2, 'sugar': 12, 'sodium': 450},
            '法式洋葱汤': {'calories': 180, 'protein': 8, 'fat': 12, 'carbohydrates': 15, 'fiber': 3, 'sugar': 8, 'sodium': 1200},
            ...
            '奶油蘑菇汤': {'calories': 220, 'protein': 8, 'fat': 18, 'carbohydrates': 12, 'fiber': 2, 'sugar': 4, 'sodium': 850},
            '墨西哥卷饼': {'calories': 380, 'protein': 22, 'fat': 18, 'carbohydrates': 35, 'fiber': 4, 'sugar': 6, 'sodium': 1200},
            ...
            '日式拉面': {'calories': 420, 'protein': 18, 'fat': 15, 'carbohydrates': 55, 'fiber': 3, 'sugar': 8, 'sodium': 1200},
            ...
            '韩式炸鸡': {'calories': 420, 'protein': 25, 'fat': 28, 'carbohydrates': 22, 'fiber': 2, 'sugar': 8, 'sodium': 850},
            '韩式炒年糕': {'calories': 280, 'protein': 8, 'fat': 8, 'carbohydrates': 45, 'fiber': 2, 'sugar': 12, 'sodium': 680},
            '韩式拌饭': {'calories': 380, 'protein': 15, 'fat': 18, 'carbohydrates': 42, 'fiber': 4, 'sugar': 8, 'sodium': 850},
            '韩式泡菜汤': {'calories': 120, 'protein': 8, 'fat': 6, 'carbohydrates': 12, 'fiber': 3, 'sugar': 4, 'sodium': 1200},
            
            # 泰餐
            '泰式咖喱': {'calories': 320, 'protein': 18, 'fat': 22, 'carbohydrates': 18, 'fiber': 4, 'sugar': 8, 'sodium': 850},
            '冬阴功汤': {'calories': 180, 'protein': 12, 'fat': 12, 'carbohydrates': 15, 'fiber': 3, 'sugar': 6, 'sodium': 1200},
            '泰式炒河粉': {'calories': 380, 'protein': 15, 'fat': 18, 'carbohydrates': 45, 'fiber': 3, 'sugar': 8, 'sodium': 1200},
            '泰式青咖喱': {'calories': 280, 'protein': 16, 'fat': 20, 'carbohydrates': 12, 'fiber': 3, 'sugar': 6, 'sodium': 850},
            
            # 其他
            '印度咖喱': {'calories': 320, 'protein': 18, 'fat': 22, 'carbohydrates': 18, 'fiber': 4, 'sugar': 8, 'sodium': 850},
        ...
        for food_name, nutrition in nutrition_data.items():
            try:
                ...
                self.stdout.write(
                    self.style.SUCCESS(f'✅ 更新: {food_name} - 卡路里: {nutrition["calories"]}千卡')
                )
                updated_count += 1
                
            except FoodItem.DoesNotExist:
                self.stdout.write(
                    self.style.WARNING(f'⚠️ 未找到: {food_name}')
                )
                not_found_count += 1
