        ...
        if remaining_images and foods_without_images:
            ...
            for cuisine, foods in cuisine_groups.items():
                ...
                for img in remaining_images:
                    img_lower = img.lower()
                    if cuisine in img_lower or any(keyword in img_lower for keyword in ['chinese', 'western', 'japanese', 'korean']):
            ...
            # 为剩余食物分配图片
            remaining_foods = [food for food in foods_without_images if not food.image_url or not food.image_url.startswith('/static/img/food/')]
