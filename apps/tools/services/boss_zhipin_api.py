    ...
    def check_qr_login_status(self, qr_code_id: str) -> Dict:
        ...
        try:
            ...
            if data.get('code') != 0:
                return {
                    'success': False,
                    'message': data.get('message', '检查登录状态失败')
                }
    ...
    def search_jobs(self, 
        ...
        try:
            ...
            if data.get('code') != 0:
                return {
                    'success': False,
                    'message': data.get('message', '搜索职位失败')
                }
    ...
    def send_contact_request(self, job_id: str, session_id: str = '') -> Dict:
        ...
        try:
            ...
            response = self.session.post(
                ...
                data=data, 
                headers=headers,
                params={'securityId': params['data']['securityId']}
            )
            ...
            if result.get('code') != 0:
                return {
                    'success': False,
                    'message': result.get('message', '发送联系请求失败')
                }
