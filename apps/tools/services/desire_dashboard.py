...
from ..models import (
    ...
    FitnessWorkoutSession, CodeWorkoutSession, DailyWorkoutChallenge
)
...
class DesireDashboardService:
    ...
    def _generate_ai_prompt(self, desire: DesireItem, task_type: str, task_details: str) -> str:
        ...
        if desire.desire_type == 'material':
            ...
            return f"Recognition and praise: {desire.title}. {task_details}. Celebration, appreciation, professional environment."
