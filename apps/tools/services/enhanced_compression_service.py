...
class EnhancedCompressionService:
    ...
    def compress_with_zip(self, 
                         file_paths: List[str], 
                         output_path: str,
                         compression_level: int = 9,
                         include_paths: bool = True) -> Tuple[bool, str]:
        """使用ZIP压缩"""
        try:
    ...
    def compress_with_7z(self, 
                        file_paths: List[str], 
                        output_path: str,
                        compression_level: int = 5) -> Tuple[bool, str]:
        """使用7Z压缩"""
        try:
            # 检查系统是否安装了7zip
            import subprocess
