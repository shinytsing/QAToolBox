...
class ZipService:
    ...
    def create_zip_from_files(self, 
                             file_paths: List[str], 
                             zip_name: str = None,
                             compression_level: int = 6,
                             include_paths: bool = True) -> Tuple[bool, str, Optional[str]]:
        """
        从多个文件创建ZIP包
        ...
        try:
            ...
            for file_path in file_paths:
                ...
                # 检查是否是媒体文件路径
                if decoded_path.startswith('audio_files/') or decoded_path.startswith('media/') or decoded_path.startswith('temp_audio/'):
                    # 构建完整的媒体文件路径
    ...
    def create_zip_from_directory(self, 
                                 ...
                                 zip_name: str = None,
                                 compression_level: int = 6,
                                 exclude_patterns: List[str] = None) -> Tuple[bool, str, Optional[str]]:
        """
        从目录创建ZIP包
    ...
    def compress_single_file(self, 
                           file_path: str,
                           compression_level: int = 9) -> Tuple[bool, str, Optional[str]]:
        """
        压缩单个文件
    ...
    def extract_zip(self, 
                   zip_path: str,
                   extract_to: str = None) -> Tuple[bool, str, Optional[str]]:
        """
        解压ZIP文件
