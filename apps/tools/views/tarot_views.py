...
TAROT_CARDS_DATA = [
    # 大阿卡纳
    {'name': '愚者', 'name_en': 'The Fool', 'card_type': 'major', 'suit': 'major', 'number': 0,
    ...
    {'name': '魔术师', 'name_en': 'The Magician', 'card_type': 'major', 'suit': 'major', 'number': 1,
    ...
    {'name': '女祭司', 'name_en': 'The High Priestess', 'card_type': 'major', 'suit': 'major', 'number': 2,
    ...
    {'name': '女皇', 'name_en': 'The Empress', 'card_type': 'major', 'suit': 'major', 'number': 3,
    ...
    {'name': '皇帝', 'name_en': 'The Emperor', 'card_type': 'major', 'suit': 'major', 'number': 4,
    ...
    {'name': '教皇', 'name_en': 'The Hierophant', 'card_type': 'major', 'suit': 'major', 'number': 5,
    ...
    {'name': '恋人', 'name_en': 'The Lovers', 'card_type': 'major', 'suit': 'major', 'number': 6,
    ...
    {'name': '战车', 'name_en': 'The Chariot', 'card_type': 'major', 'suit': 'major', 'number': 7,
    ...
    {'name': '力量', 'name_en': 'Strength', 'card_type': 'major', 'suit': 'major', 'number': 8,
    ...
    {'name': '隐者', 'name_en': 'The Hermit', 'card_type': 'major', 'suit': 'major', 'number': 9,
    ...
    {'name': '命运之轮', 'name_en': 'Wheel of Fortune', 'card_type': 'major', 'suit': 'major', 'number': 10,
    ...
    {'name': '正义', 'name_en': 'Justice', 'card_type': 'major', 'suit': 'major', 'number': 11,
    ...
    {'name': '倒吊人', 'name_en': 'The Hanged Man', 'card_type': 'major', 'suit': 'major', 'number': 12,
    ...
    {'name': '死神', 'name_en': 'Death', 'card_type': 'major', 'suit': 'major', 'number': 13,
    ...
    {'name': '节制', 'name_en': 'Temperance', 'card_type': 'major', 'suit': 'major', 'number': 14,
    ...
    {'name': '恶魔', 'name_en': 'The Devil', 'card_type': 'major', 'suit': 'major', 'number': 15,
    ...
    {'name': '高塔', 'name_en': 'The Tower', 'card_type': 'major', 'suit': 'major', 'number': 16,
    ...
    {'name': '星星', 'name_en': 'The Star', 'card_type': 'major', 'suit': 'major', 'number': 17,
    ...
    {'name': '月亮', 'name_en': 'The Moon', 'card_type': 'major', 'suit': 'major', 'number': 18,
    ...
    {'name': '太阳', 'name_en': 'The Sun', 'card_type': 'major', 'suit': 'major', 'number': 19,
    ...
    {'name': '审判', 'name_en': 'Judgement', 'card_type': 'major', 'suit': 'major', 'number': 20,
    ...
    {'name': '世界', 'name_en': 'The World', 'card_type': 'major', 'suit': 'major', 'number': 21,
    ...
    try:
        ...
        if TarotCard.objects.exists():
            return JsonResponse({
                'success': True,
                'message': '塔罗牌数据已存在',
                'cards_count': TarotCard.objects.count()
            })
