...
# QAToolBox 阿里云完整部署脚本（修复Python 3.12兼容性问题）
# 解决setuptools、Fortran编译器、numpy等兼容性问题
...
log_info "🚀 QAToolBox 阿里云完整部署脚本（修复Python 3.12兼容性）"
log_info "=========================================================="
...
# 3. 升级pip和基础工具到最新版本
log_info "⬆️ 升级pip和基础工具到最新版本..."
pip install --upgrade pip
pip install --upgrade setuptools==75.6.0
pip install --upgrade wheel==0.45.1
log_success "pip和基础工具已升级"

# 4. 安装Python 3.12兼容的科学计算库（使用预编译版本）
...
log_success "AI/ML库安装完成"

# 10. 安装requirements.txt中的剩余依赖（跳过已安装的）
