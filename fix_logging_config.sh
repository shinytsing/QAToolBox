...
log_info "=========================================="
log_info "QAToolBox 修复Django日志配置脚本"
log_info "=========================================="
...
mkdir -p /home/admin/QAToolbox/logs
chown -R admin:admin /var/log/qatoolbox
chown -R admin:admin /home/admin/QAToolbox/logs

# 创建日志文件
touch /var/log/qatoolbox/django.log
touch /var/log/qatoolbox/gunicorn_access.log
touch /var/log/qatoolbox/gunicorn_error.log
touch /home/admin/QAToolbox/logs/django.log

# 设置权限
chown admin:admin /var/log/qatoolbox/django.log
chown admin:admin /var/log/qatoolbox/gunicorn_access.log
chown admin:admin /var/log/qatoolbox/gunicorn_error.log
chown admin:admin /home/admin/QAToolbox/logs/django.log

chmod 644 /var/log/qatoolbox/django.log
chmod 644 /var/log/qatoolbox/gunicorn_access.log
chmod 644 /var/log/qatoolbox/gunicorn_error.log
chmod 644 /home/admin/QAToolbox/logs/django.log

# 2. 检查Django设置文件
log_info "检查Django设置文件..."
if [ -f "config/settings/production.py" ]; then
    log_info "找到production.py设置文件"
...
EOF
    ...
    log_success "日志配置修复完成"
else
    log_error "未找到production.py设置文件"
    exit 1
fi
