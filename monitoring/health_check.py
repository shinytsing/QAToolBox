...
def main():
    ...
    if args.json:
        ...
        print(f"检查项目: {summary['total']} (健康: {summary['healthy']}, 警告: {summary['warning']}, 严重: {summary['critical']})")
        print()
