...
# 6. 创建项目目录
log_info "📁 创建项目目录..."
mkdir -p /var/www/qatoolbox
cd /var/www/qatoolbox

# 7. 克隆代码
log_info "📥 克隆QAToolBox代码..."
...
echo "  - QAToolBox: $(supervisorctl status qatoolbox | awk '{print $2}')"
echo ""
echo "📁 重要目录:"
...
echo ""
log_warning "⚠️ 请记得:"
echo "  1. 配置SSL证书: certbot --nginx -d shenyiqing.xin -d www.shenyiqing.xin"
echo "  2. 修改默认密码"
echo "  3. 配置邮件服务"
echo "  4. 定期备份数据库"